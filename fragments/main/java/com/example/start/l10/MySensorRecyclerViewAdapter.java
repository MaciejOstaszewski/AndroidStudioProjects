...
import com.example.start.l10.SensorListFragment.OnListFragmentInteractionListener;
import com.example.start.l10.dummy.SensorContent.SensorItem;
...
public class MySensorRecyclerViewAdapter extends RecyclerView.Adapter<MySensorRecyclerViewAdapter.ViewHolder> {
    ...
    public MySensorRecyclerViewAdapter(List<SensorItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
